{
  "preamble": "const datadir = \"data/lid-tang/bn010\"; const U = 0.01; const mu_p = 0.0075; const tau_y = 0.0000001; const m = 1.0e8; const max_iters = 50; const tol = 0.001; const Re = U * 75 / mu_p; const Bn = tau_y * 75 / (mu_p * U); info(\"Re = $Re, Bn = $Bn\"); using PyPlot;",

{
  "preamble": "const pgrad = -5.2e-6; const f = [-pgrad; 0.0]; const datadir = \"data/poise_tauy-000000\"; const mu_p = 0.2; const tau_y = 0.00000; const m = 1.0e8; const max_iters = 150; const tol = 1e-6;",

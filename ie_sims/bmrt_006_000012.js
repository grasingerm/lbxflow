{
  "preamble": "const pgrad = -5.2e-6; const f = [-pgrad; 0.0]; const datadir = \"data/bmrt_006_000012\";",
  "datadir": "data/bmrt_006_000012",
  "dx": 1.0,
  "dt": 1.0,
  "ni": 40,
  "nj": 25,
  ...
  "col_f": "begin;
              curry_mrt_bingham_col_f!(lat, msm) = mrt_fallah_bingham_col_f!(
                lat, msm, vikhansky_relax_matrix, 0.06, 12.0e-5, 1.0e6, 1.0e-11,
                f);
